...
public class CustomerService {
	...
	public List<User> registerUser(int userNo, String id, String password, int age, String userRegDate,Array favGenre,
			Array favTag) throws SQLException, NotFoundException {
